...
while ($cu = mysql_fetch_array($sql)) {
                ...
                if ($is_adminOfCourse) { // display actions
                        $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">".
                                ...
                                "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='htmlspecialchars($_SERVER[PHP_SELF], ENT_QUOTES, 'UTF-8')?del=$cu[id]' " .
                                "onClick=\"return confirmation();\">" .
                                "<img src='../../template/classic/img/delete.gif' " .
                                "title='$langDelete'></img></a></td>" .
                                "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='htmlspecialchars($_SERVER[PHP_SELF], ENT_QUOTES, 'UTF-8')?vis=$cu[id]'>" .
                                "<img src='../../template/classic/img/$icon_vis' " .
                                "title='$langVisibility'></img></a></td>";
                        if ($cu['id'] != $last_id) {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='htmlspecialchars($_SERVER[PHP_SELF], ENT_QUOTES, 'UTF-8')?down=$cu[id]'>" .
                                "<img src='../../template/classic/img/down.gif' title='$langDown'></img></a></td>";
                        } else {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                        }
                        if (!$first) {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='htmlspecialchars($_SERVER[PHP_SELF], ENT_QUOTES, 'UTF-8')?up=$cu[id]'><img src='../../template/classic/img/up.gif' title='$langUp'></img></a></td>";
                        } else {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                        }
                }
