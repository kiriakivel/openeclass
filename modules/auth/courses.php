		...
		if (isset($result))  {
			...
			while ($fac = mysql_fetch_array($result)) {
				...
				$tool_content .= "\n<td>&nbsp;<img src='../../images/arrow_blue.gif' />&nbsp;
					<a href='". htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'). "?fc=$fac[id]'>" . htmlspecialchars($fac['name']) . "</a> <small><font color='#a33033'>($fac[code])</font></small>";
...
function collapsed_facultes_horiz($fc) {
	...
	$retString = "\n   <form name='depform' action='". htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'). "' method='get'>\n";
